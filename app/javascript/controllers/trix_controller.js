...
export default class TrixController extends Controller {
  static TOOLBAR_BUTTON_ICONS = [
    ...
    {
      identifier: "[title='Strikethrough']",
    ...
    {
      identifier: "[title='Decrease Level']",
    ...
    {
      identifier: "[title='Increase Level']",
